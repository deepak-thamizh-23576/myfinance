 ...
 */
export declare class NoSQLUnMarshall {
    /**
     * Make a native or near-native js object from NoSQL attribute
     * @param attr NoSQL attribute to be convertedd
     ...
     */
    static makeMap(map: Record<string, TNoSQLAttribute | TNoSQLAttributeResponse>): Record<string, TNoSQLValues>;
    /**
