...
class DefaultHttpResponse {
    ...
    get data() {
        switch (this.config.expecting) {
            case "string" /* ResponseType.STRING */:
            ...
            case "buffer" /* ResponseType.BUFFER */:
...
function _request(transport, options, config, data, retryCount = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const clonedData = data === undefined
            ? undefined
            : config.type !== "file" /* RequestType.FILE */
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            const req = transport.request(options, (res) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (config.expecting === "raw" /* ResponseType.RAW */) {
            ...
            if (config.type !== "file" /* RequestType.FILE */) {
                req.write(data);
                req.end();
                return;
            }
...
function sendRequest(config) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (config.data !== undefined) {
            switch (config.type) {
                case "json" /* RequestType.JSON */:
                    data = JSON.stringify(config.data);
                    headers['Content-Type'] = 'application/json';
                    break;
                case "file" /* RequestType.FILE */:
                    data = config.data;
